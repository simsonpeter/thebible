...
export const BOOK_CATALOG: BookDefinition[] = [
  ...
  { id: "luke", order: 42, testament: "NT", nameEnglish: "Luke", nameTamil: "லூக்கா", chapterCount: 24, aliases: ["luke", "lk", "lu", "லூக்கா"] },
  { id: "john", order: 43, testament: "NT", nameEnglish: "John", nameTamil: "யோவான்", chapterCount: 21, aliases: ["john", "jhn", "jn", "joh", "யோவான்"] },
  { id: "acts", order: 44, testament: "NT", nameEnglish: "Acts", nameTamil: "அப்போஸ்தலர்", chapterCount: 28, aliases: ["acts", "act", "ac", "அப்போஸ்தலர்", "அப்போஸ்தலர் நடபடிகள்"] },

    ...
    <Page title="Privacy Policy" subtitle={APP_NAME} back>
      <article className="grid gap-4 text-sm leading-relaxed">
        ...
        <p>
          ...
          bookmarks, highlights, reading history, reading plans, and sermons stay on this device in IndexedDB.
        </p>
        <p>
          ...
          as authorized BSI New Ortho. The app never uploads verse text, notes, sermons, or bookmarks. Share and
          download are started by you, so you can put a sermon file in Google Drive yourself.
        </p>
